...
public class CommonUrl {
	...
	private static final String netUrl="http://123.206.227.249/";//123.206.227.249/
	...
	public static final String getYuePaiInfo    = url + "appointment/list";//获得约拍详情
	public static final String settingChangeNetUrl=url+"PswChange";
	...
	public static final String getOrdersInfo = url + "appointment/choose"; //选择约拍对象，完成约拍
	...
	public static String praisePhotoset=url+"Userinfo/CollectionHandler";
	public static String praiseActivity=url+"Activity/entry";
	public static String favouriteYuepai=url+"user/favorite";

	public static final String askYuepai = url+ "appointment/list"; //获得约拍系列信息
	...
	public static final String imgSelfAndSets = url + "collection/createCollect";//个人照片和照片集

	public static String userImage = url + "collection/requestCollect"; //个人照片及作品集
	...
	public static String forgotpw = url + "login/forgotpw"; //用户忘记密码

	public static  String trend =url+"trend/requestTrend"; //下拉刷新动态

	public static String collection=url+"collection/requestCollect"; //下拉刷新作品集

	public static final String getFCInfo    = url + "community/requestQuestion";//获得论坛社区动态2

	public static final String sendFCInfo =url +"community/createQuestion";//发送论坛问题

	public static final String sendComment  = url +"community/commentQuestion" ;//发送评论

	public static final String getFavor = url + "community/likeQuestion"; //点赞问题

	public static final String getCollect =  url + "community/collectQuestion"; //收藏问题

	public static final String sendTrend=url+"trend/creatTrend"; //发布动态

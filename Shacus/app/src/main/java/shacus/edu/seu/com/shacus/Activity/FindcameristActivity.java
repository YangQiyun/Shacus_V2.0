 ...
 */
public class FindcameristActivity extends BaseActivity implements View.OnClickListener{
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
           PlaceholderFragment frag= PlaceholderFragment.newInstance(position,0);
            return frag;
        }

...
import shacus.edu.seu.com.shacus.Activity.ImageDetailsActivity;
import shacus.edu.seu.com.shacus.Data.Model.Images;
import shacus.edu.seu.com.shacus.R;
import shacus.edu.seu.com.shacus.Utils.ImageLoader;
			...
			if (mImageView != null) {
				...
				imageView.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						imageURL=trans(Images.imageUrls);
						Bundle b=new Bundle();
						b.putStringArrayList("imageurl", imageURL);
						intent.putExtras(b);

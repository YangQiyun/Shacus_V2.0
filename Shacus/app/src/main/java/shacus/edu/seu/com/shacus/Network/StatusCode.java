...
public interface StatusCode {
    ...
    //请求我关注的用户（我的关注）
    int REQUEST_INFO_FOLLOWING = 80020;
    int REQUEST_FOLLOWING_SUCCESS = 800200; //请求我的关注成功
    int REQUEST_FOLLOWING_NONE = 800201; //用户没有关注任何人
    int REQUEST_USER_ILLEGAL = 10412; //用户不合法

    //请求取消关注
    int REQUEST_CANCEL_FOLLOWING = 80022;
    int REQUEST_CANCEL_SUCCESS = 800220; //请求取消关注成功
    int REQUEST_CANCEL_NONE = 800222; //未关注该用户

    //请求关注
    int REQUEST_FOLLOW_USER = 80021;
    int RESPONSE_ALREADY_FOLLOW_USER = 800210;
    int REQUEST_FOLLOW_SUCCESS = 800211; //请求关注成功


    //请求我的粉丝
    int REQUEST_INFO_FOLLOWER = 80023;
    int REQUEST_FOLLOWER_SUCCESS = 800230; //请求我的粉丝成功
    int REQUEST_FOLLOWER_NONE = 800231;//没有粉丝
    ...
    int PHOTOSELF_ADD_IMGS_1 = 85085;//个人照片添加第一步
    int UPDATE_DELETE_SELFIMG = 10811;//个人照片的删除
    int UPDATE_DELETE_SETIMG = 10820;//作品集内图片的删除
    int PHOTOSELF_ADD_IMGS_2 = 85086;//个人照片添加第二步，与个人照片更新请求是一样的
    int PHOTOSET_ADD_SETS_1 = 85081;//添加作品集第一步
    int PHOTOSET_ADD_SETS_2 = 85082;//添加作品集第二步
    int PHOTOSET_ADD_IMGS_1 = 10822;//给作品集添加图片第一步
    int PHOTOSET_ADD_IMGS_2 = 10824;//给作品集添加图片第二步
    int UPDATE_DELETE_PHOTOSET = 10826;//删除作品集
    int REQUEST_USER_GRZP = 85105;// 个人照片
    int REQUEST_USER_GRZP_SUCCESS = 851050;
    int REQUEST_USER_ZPJ = 85107;//作品集封面
    int REQUEST_USER_ZPJ_SUCCESS = 851070;
    int REQUEST_PHOTOSET_DETAIL=85109;//作品集详情图
    int REQUEST_PHOTOSET_DETAIL_FAIL=851092;//作品集加载失败
    int REQUEST_PHOTOSET_DETAIL_SUCCESS=851090;//作品集请求成功

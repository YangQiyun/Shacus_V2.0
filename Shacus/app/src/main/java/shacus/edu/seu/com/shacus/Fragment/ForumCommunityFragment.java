...
import static shacus.edu.seu.com.shacus.Utils.StatusCode.REQUEST_COMMUNITY_FORUM_LIST_ERROR;
import static shacus.edu.seu.com.shacus.Utils.StatusCode.REQUEST_COMMUNITY_FORUM_LIST_SUCCESS;
import static shacus.edu.seu.com.shacus.Utils.StatusCode.REQUEST_COMMUNITY_MORE_FORUM_LIST_ERROR;
import static shacus.edu.seu.com.shacus.Utils.StatusCode.REQUEST_COMMUNITY_MORE_FORUM_LIST_SUCCESS;
import static shacus.edu.seu.com.shacus.Utils.StatusCode.WANT_COMMUNITY_FORUM_LIST;

/**
 * Created by Administrator on 2017/9/14.
 */

public class ForumCommunityFragment extends BaseFragment implements AbsListView.OnScrollListener {
    ...
    private Handler mHander = new Handler(new Handler.Callback(){
        ...
        public boolean handleMessage(Message msg) {
            switch(msg.what){
                case REQUEST_COMMUNITY_FORUM_LIST_SUCCESS:
                    Log.d("handle","new");
                    ...
                    break;
                case REQUEST_COMMUNITY_MORE_FORUM_LIST_SUCCESS:
                    Log.d("handle","more");
                    bootCounter+=msg.arg1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mRootView = inflater.inflate(R.layout.fragment_forum_community, container, false);


        communityLv = findViewById(R.id.communityListView);
        forumItemManager = new ForumItemManager(getActivity(),mHander,WANT_COMMUNITY_FORUM_LIST);
        ...
        communityLv.addFooterView(loadmoreView,null,false);
        communityLv.setOnScrollListener(this);
        ...
        //设置下拉刷新效果
        pullRefreshLayout = findViewById(R.id.swipeRefreshLayout1);
...
//        pullRefreshLayout.setColor(int);
    ...
    public void loadComplete()
    {
        ...
        communityLv.removeFooterView(loadmoreView);//如果是最后一页的话，则将其从ListView中移出
